...
<html lang="en">
<head>
    <title>E-Meals - Admin/Reviews</title>
    ...
    <div class="admin-dashboard-container">
                ...
                <div class="admin-nav-menu">
                    <ul>
                        ...
                        <li style="background-color:var(--active-color);">
                            <a href="review.php" style="color:var(--bg-color); width: 100%;">
        ...
        <div class="admin-content-display">
            <div class="admin-content-header">
                ...
                <div class="header-welcome-box">
                    <div class="name-box">
                        <span>Dashboard</span> - User Reviews
                    </div>
                </div>
            </div>
            ...
            <div class="admin-content-box">
                ...
                <div class="box-content-heading">All Reviews</div>
                    ...
                    <table>
                        ...
                        <?php
                            ...
                            if(isset($_GET['page']) && $_GET['page'] != ""){
                             ...
                             $results_per_page = 5;
                             $pick = mysqli_query($db, "SELECT * FROM review_table");
                             $total_results = mysqli_num_rows($pick);
                             $total_page_num = ceil($total_results/$results_per_page);
                             $offset = ($page - 1) * $results_per_page;

                            $select = mysqli_query($db, "SELECT * FROM review_table LIMIT $offset, $results_per_page");
                            ...
                            if($num > 0){
                                ...
                                $date = date('d-M-y h:ia', strtotime($selected['date']));
                                $id = $selected['id'];
                        ...
                        <tr>
                            ...
                            <td>
                                <?php 
                                    $choose = mysqli_query($db, "SELECT * FROM food_table WHERE id = '$food_id'");
                            ...
                            <td><?php echo $rating; ?> <span class="fas fa-star" style="color:orange;"></span></td>
                            <td><?php echo $date; ?></td>
                            <td><a href="delete.php?action=delete_review&id=<?php echo $id; ?>" class="fas fa-trash" onclick="return confirm('Are you sure?')"></a></td>
                        </tr>
                ...
                <div class="pagination">
                    <ul>
                        <?php include_once('includes/review_table_pagination.php'); ?>
                    </ul>
                </div>
